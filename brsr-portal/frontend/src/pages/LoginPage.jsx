...
const LoginPage = () => {
    ...
    const from = location.state?.from || '/brsr/dashboard';
        ...
        <div className="min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                ...
                <p className="text-center text-dimmed text-xs mt-6">
                    Access to the BRSR reporting portal is by invitation. Contact info@sustainsutra.in for access.
                </p>
            </div>
        </div>
    );
