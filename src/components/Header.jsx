...
const Header = () => {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 z-50 transition-smooth ${isScrolled ? 'glassmorphism-strong shadow-lg' : 'glassmorphism'}`}>
            ...
            {/* Mobile Menu Toggle */}
            <button
                className="lg:hidden text-offwhite p-2 hover:bg-white/5 rounded-lg transition-colors relative z-50"
    ...
    {
        isMenuOpen && (
            <div className="lg:hidden fixed inset-0 bg-navy z-40 overflow-y-auto">
